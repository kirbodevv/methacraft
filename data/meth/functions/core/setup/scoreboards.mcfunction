...
execute unless score $meth_clearance_threshold meth_settings matches 0.. scoreboard players set $meth_clearance_threshold meth_settings 0
execute unless score $meth_clearance_threshold meth_settings matches 0.. scoreboard players set $meth_addiction_threshold meth_settings 600
execute unless score $meth_clearance_threshold meth_settings matches 0.. scoreboard players set $meth_increase_stage_value meth_settings 9000
execute unless score $meth_clearance_threshold meth_settings matches 0.. scoreboard players set $meth_lethal_dose meth_settings 0
