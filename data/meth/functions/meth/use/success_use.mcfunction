...
execute if score @s want_use_meth matches 3 run function meth:meth/use/red_effects
execute if score @s want_use_meth matches 4 run function meth:meth/use/meth_effects